        ...
        <?php if (!$quiz_completed && $_SESSION['quiz_attempts'] < 6): ?>
            <form method="post">
                <div class="question">
                    ...
                    <div class="options">
                        <label><input type="radio" name="q1" value="a" required> Sad</label>
                        <label><input type="radio" name="q1" value="b"> Joyful</label>
                        <label><input type="radio" name="q1" value="c"> Angry</label>
                    </div>
                </div>
                <div class="question">
                    <h3>2. What is the plural of 'Child'?</h3>
                    <div class="options">
                        <label><input type="radio" name="q2" value="a" required> Children</label>
                        <label><input type="radio" name="q2" value="b"> Childs</label>
                        <label><input type="radio" name="q2" value="c"> Childes</label>
                    </div>
                </div>
                <div class="question">
                    <h3>3. What is the past tense of 'Run'?</h3>
                    <div class="options">
                        <label><input type="radio" name="q3" value="a" required> Running</label>
                        <label><input type="radio" name="q3" value="b"> Runs</label>
                        <label><input type="radio" name="q3" value="c"> Ran</label>
                    </div>
                </div>
