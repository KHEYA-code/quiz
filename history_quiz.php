        ...
        <?php if (!$quiz_completed && $_SESSION['quiz_attempts'] < 6): ?>
            <form method="post">
                <div class="question">
                    ...
                    <div class="options">
                        <label><input type="radio" name="q1" value="a" required> Abraham Lincoln</label>
                        <label><input type="radio" name="q1" value="b"> Thomas Jefferson</label>
                        <label><input type="radio" name="q1" value="c"> George Washington</label>
                    </div>
                </div>
                <div class="question">
                    <h3>2. In which year did World War II end?</h3>
                    <div class="options">
                        <label><input type="radio" name="q2" value="a" required> 1945</label>
                        <label><input type="radio" name="q2" value="b"> 1939</label>
                        <label><input type="radio" name="q2" value="c"> 1918</label>
                    </div>
                </div>
                <div class="question">
                    <h3>3. Who wrote the Declaration of Independence?</h3>
                    <div class="options">
                        <label><input type="radio" name="q3" value="a" required> Benjamin Franklin</label>
                        <label><input type="radio" name="q3" value="b"> Thomas Jefferson</label>
                        <label><input type="radio" name="q3" value="c"> John Adams</label>
                    </div>
                </div>
