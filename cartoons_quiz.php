...
<body>
    <div class="quiz-container">
        ...
        <?php if (!$quiz_completed && $_SESSION['quiz_attempts'] < 2): ?>
            <form method="post">
                <!-- Question 1 -->
                <div class="question">
                    <h3>1. What is the name of Mickey Mouse's dog?</h3>
                    <div class="options">
                        <label><input type="radio" name="q1" value="a" required> Pluto</label>
                        <label><input type="radio" name="q1" value="b"> Goofy</label>
                        <label><input type="radio" name="q1" value="c"> Donald</label>
                    </div>
                </div>

                <!-- Question 2 -->
                <div class="question">
                    <h3>2. Which cartoon character says, "What's up, doc?"</h3>
                    <div class="options">
                        <label><input type="radio" name="q2" value="a" required> Mickey Mouse</label>
                        <label><input type="radio" name="q2" value="b"> Tom</label>
                        <label><input type="radio" name="q2" value="c"> Bugs Bunny</label>
                    </div>
                </div>

                <!-- Question 3 -->
                <div class="question">
                    <h3>3. What is the name of the pink starfish in SpongeBob SquarePants?</h3>
                    <div class="options">
                        <label><input type="radio" name="q3" value="a" required> Sandy</label>
                        <label><input type="radio" name="q3" value="b"> Patrick</label>
                        <label><input type="radio" name="q3" value="c"> Squidward</label>
                    </div>
                </div>

                <button type="submit" name="submit_quiz">Submit</button>
            </form>
        <?php elseif ($quiz_completed && $_SESSION['quiz_attempts'] < 6): ?>
            <form method="post">
                <p>Your score: <?= $score ?> out of <?= $total_questions ?></p>
                <button type="submit" name="reattempt">Reattempt Quiz</button>
